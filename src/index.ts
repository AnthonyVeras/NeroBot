 ...
 *
 * Abra a pasta "src"
 * Vá no arquivo "utils/messages.ts" e edite o menu!
 ...
 * Substitua a imagem "nero-bot.png" por outra de sua preferência!
 * Só não esqueça de manter o nome "nero-bot.png"
 *
 * ---------------- 🚀 IMPORTANTE 🚀 ----------------
 *
 * Leia o tutorial completo do bot para entender melhor seu funcionamento.
 *
...
import { infoLog, bannerLog } from "./utils/logger";
